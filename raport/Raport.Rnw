...
\begin{itemize}
    \item
	\textbf{EDT} w pasmach oktaw. (rys. 3, tab. \ref{tab:edtoct}) i 1/3 oktaw. (rys. 4,
	tab. \ref{tab:edtter}).
\end{itemize}
...
\begin{itemize}
	...
	\ref{tab:t20oct}) i 1/3 oktaw. (rys. 6, tab. \ref{tab:t20ter}).
\end{itemize}
...
\begin{itemize}
    \item
	\textbf{INR} w pasmach oktaw. (rys. 8, tab. \ref{tab:inroct}) i 1/3 oktaw. (rys. 9, tab. \ref{tab:inrter}).
\end{itemize}
...
\begin{itemize}
    \item
	\textbf{C\textsubscript{80}}(rys. 10) (wyniki z danego źródła są zaznaczone
	kolorem).
\end{itemize}
